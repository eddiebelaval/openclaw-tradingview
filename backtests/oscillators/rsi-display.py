"""
DS-TV Backtest Results: rsi-display
============================================================
...
Source: TradingView Community Script — rsi-display
...
class TvStrategy(Strategy):
    ...
    def next(self):
        ...
        if crossover(self.rsi, rsi_oversold):
            if not self.position:
                self.buy()
        elif crossover(rsi_overbought, self.rsi):
            if self.position:
                self.position.close()
