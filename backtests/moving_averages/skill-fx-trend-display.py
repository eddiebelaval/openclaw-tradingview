"""
DS-TV Backtest Results: skill-fx-trend-display
============================================================
...
Source: TradingView Community Script — skill-fx-trend-display
...
class TvStrategy(Strategy):
    def init(self):
        ...
        self.ma_fast = self.I(pta.sma, close, length=10)
        self.ma_slow = self.I(pta.sma, close, length=20)
