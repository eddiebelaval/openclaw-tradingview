"""
DS-TV Backtest Results: my-script
============================================================
...
Source: TradingView Community Script — my-script
...
class TvStrategy(Strategy):
    def init(self):
        # Since this is just plotting close price with no indicator logic,
        # we'll create a simple strategy based on close price crossover with SMA
